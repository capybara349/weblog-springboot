...
import com.capybara349.weblog.admin.convert.WikiConvert;
import com.capybara349.weblog.admin.model.vo.wiki.*;
import com.capybara349.weblog.admin.service.AdminWikiService;
import com.capybara349.weblog.common.domain.dos.ArticleDO;
import com.capybara349.weblog.common.domain.dos.WikiCatalogDO;
import com.capybara349.weblog.common.domain.dos.WikiDO;
import com.capybara349.weblog.common.domain.mapper.ArticleMapper;
import com.capybara349.weblog.common.domain.mapper.WikiCatalogMapper;
import com.capybara349.weblog.common.domain.mapper.WikiMapper;
import com.capybara349.weblog.common.enums.ArticleTypeEnum;
import com.capybara349.weblog.common.enums.ResponseCodeEnum;
import com.capybara349.weblog.common.enums.WikiCatalogLevelEnum;
...
public class AdminWikiServiceImpl implements AdminWikiService {
    ...
    public Response addWiki(AddWikiReqVO addWikiReqVO) {
        ...
        // 获取新增记录的主键
        Long wikiDOId = wikiDO.getId();

        // 初始化目录
        wikiCatalogMapper.insert(WikiCatalogDO.builder().wikiId(wikiDOId).title("概述").sort(1).build());
        wikiCatalogMapper.insert(WikiCatalogDO.builder().wikiId(wikiDOId).title("基础").sort(2).build());
