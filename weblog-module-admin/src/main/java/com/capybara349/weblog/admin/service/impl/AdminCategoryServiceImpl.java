...
import com.capybara349.weblog.admin.model.vo.category.FindCategoryPageListRspVO;
import com.capybara349.weblog.admin.service.AdminCategoryService;
...
public class AdminCategoryServiceImpl implements AdminCategoryService {
    ...
    public PageResponse findCategoryList(FindCategoryPageListReqVO findCategoryPageListReqVO) {
        ...
        wrapper
                .like(StringUtils.isNotBlank(name), CategoryDO::getName, name)
